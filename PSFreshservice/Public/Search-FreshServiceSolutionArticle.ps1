...
#>
function Search-FreshServiceSolutionArticle {
    ...
    begin {
        ...
        $uri = [System.UriBuilder]('{0}/solutions/articles/search' -f $PrivateData['FreshserviceBaseUri'])
    ...
    process {
        ...
        try {
            ...
            $results = do {
                ...
                Write-Verbose ("Articles in payload {0} for page {1}:" -f $content.articles.count, $page)
                # $content

                if ($content) {
                    #API returns singluar or plural property based on the number of records, parse to get property returned.
                    $objProperty = $content[0].PSObject.Properties.Name |
                                        Where-Object -FilterScript {$_ -like 'article*'}
            ...
            until ($content.meta.total_items -eq 0)

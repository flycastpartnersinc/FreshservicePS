...
.DESCRIPTION
    Gets a Freshservice connection(s) stored in the configuration file %APPDATA%\PSFreshservice\PSFreshservice.config. Freshservice is a session-less API, the settings created with this cmdlet are used as

<#
.SYNOPSIS
    Returns a Freshservice application (i.e. software) user.

.DESCRIPTION
    Returns a Freshservice application (i.e. software) user via REST API.
...
#>
function Get-FreshServiceSoftwareUser {
    [CmdletBinding(DefaultParameterSetName = 'default')]
    param (
        [Parameter(
            Mandatory = $true,
            HelpMessage = 'Unique id of the software to get user information from.',
